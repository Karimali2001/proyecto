...
# Inicializamos la variable global aquí para evitar errores de alcance
detections = []
...
def draw_objects(request):
    # Accedemos a la variable global 'detections' que actualiza el bucle principal
    global detections
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model", help="Path for the HEF model.", default=default_model_path)
    ...
    with Hailo(args.model) as hailo:
        ...
        with Picamera2() as picam2:
            ...
            print("Inferencia corriendo. Pulsa Ctrl+C en la terminal para detener.")
